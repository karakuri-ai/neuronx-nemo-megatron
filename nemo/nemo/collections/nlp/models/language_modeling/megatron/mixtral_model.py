...
from nemo.collections.nlp.modules.common.megatron.mixtral_module import get_mixtral_language_model
...
class MixtralModel(MegatronModule):
    ...
    def __init__(
        ...
        super(MixtralModel, self).__init__(share_token_embeddings=share_embeddings_and_output_weights)
        ...
        self.language_model, self._language_model_key = get_mixtral_language_model(
